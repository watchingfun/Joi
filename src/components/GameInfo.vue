...
<template>
	<div class="relative">
		<div :class="['row-item', record.participants[0].stats.win ? 'win' : 'fail']">
			...
			<div
				:style="{
					color: record.participants[0].stats.win ? '#3aff95a1' : 'rgb(255 0 35)'
				}"
				:class="['result', record.participants[0].stats.win ? 'win-result' : 'fail-result']">
			...
			<div class="kda-group">
				...
				<div class="kda">
					...
					<span class="text-red-600">{{ record.participants[0].stats.deaths }}</span>
					/
				...
				<div class="minions">
					{{ record.participants[0].stats.totalMinionsKilled + record.participants[0].stats.neutralMinionsKilled }}
				</div>
			</div>
		</div>
		<div class="date-info">
