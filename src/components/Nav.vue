<template>
	<div class="relative shiny">
		<n-tabs ref="tabsInstRef" type="line" v-model:value="navStore.activeKey" animated size="large" :tabs-padding="36">
			<n-tab
		...
		<div
			...
			style="
				...
				gap: 4px;
			">
			<n-input clearable @keyup.native.enter="search" v-model:value="searchVal" placeholder="输入召唤师昵称" />
